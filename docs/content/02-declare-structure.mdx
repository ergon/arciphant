...
Normally, if you want to build this structure with nested Gradle projects, you have a lot of duplicated build setup.
With Arciphant you can configure a template that defines the structure of the components (rings) of a module and then
use this template to create (instantiate) the 4 modules:
