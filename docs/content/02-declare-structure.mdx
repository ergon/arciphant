...
In above example this means that _web_ and _db_ can access _domain_ thanks to the API dependency to _application_.
...
Each component of each domain module will automatically get a dependency to the respective component in the library
module.
...
It is also possible to declare explicit dependencies, e.g. if you need multiple different bundles who should _not_
