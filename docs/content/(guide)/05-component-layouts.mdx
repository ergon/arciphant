...
[Structurize test code](/declare-structure#structurize-test-code).
...
convention plugin. Arciphant registers two extensions in every functional module project to do so:
