...
| Example                                                                                                                                                                                                      | Description                                                                                                                                                                                                                        |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <a href="https://github.com/ergon/arciphant/tree/main/examples/source-set-customization" target="_blank" rel="noreferrer"><code style={{whiteSpace: 'nowrap'}}>source-set-customization</code></a>           | Relocating the source directories of components in the source set layout with `customizeAllComponents` and `customizeComponent`. See [Customizing source directories](/component-layouts#customizing-source-directories).          |
| <a href="https://github.com/ergon/arciphant/tree/main/examples/test-source-set-configuration" target="_blank" rel="noreferrer"><code style={{whiteSpace: 'nowrap'}}>test-source-set-configuration</code></a> | Configuring test and test fixtures source sets in the source set layout: global flags, per-component overrides and custom source set names. See [Test source set configuration](/component-layouts#test-source-set-configuration). |
