...
![Four modules with the components domain, application, web and db](../images/structure-01-modules.drawio.png)
...
![Two modules whose components depend on the same-named components of a shared library module](../images/structure-02-library.drawio.png)
...
![Modules C and D with an additional fs component, modules A and B without](../images/structure-03-different-shapes.drawio.png)
...
![Module D with an individual ext-api component](../images/structure-04-individual-shapes.drawio.png)
