...
Above configuration creates the following structure and sets up the dependencies between the components (domain,
...
<Tabs>
  <Tab title="Project layout">
    ...
    [Structurize test code](#structurize-test-code).
  </Tab>
