...
internal class PackageStructureValidationBuilder : PackageStructureValidationDsl {
    ...
    fun build(): PackageStructureValidationConfig {
        return PackageStructureValidationConfig(
            ...
            relativePackagesByProjectName = relativePackagesByProjectName,
            absolutePackagesByProjectPath = absolutePackagesByProjectPath,
            excludedProjectPaths = excludedProjectPaths,
            excludedSourceFolders = excludedSrcFolders + listOfNotNull(
                if (excludeResourcesFolder) "main/resources" else null,
            )
        )
    }
